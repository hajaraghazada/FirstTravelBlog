...
{
    /// <inheritdoc />
    public partial class _072224Blogdb : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TravelActivities_Destinations_DestinationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DestinationTrip_Tips_TripsId",
                        column: x => x.TripsId,
                        principalTable: "Tips",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DestinationTrips", x => new { x.TripId, x.DestinationId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DestinationTrips_Tips_TripId",
                        column: x => x.TripId,
                        principalTable: "Tips",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TravelReviews", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TravelReviews_Tips_TripId",
                        column: x => x.TripId,
                        principalTable: "Tips",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TravelReviews_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TravelActivities_DestinationId",
                table: "TravelActivities",
                column: "DestinationId");

            migrationBuilder.CreateIndex(
                name: "IX_TravelReviews_TripId",
                table: "TravelReviews",
                column: "TripId");

            migrationBuilder.CreateIndex(
                name: "IX_TravelReviews_UserId",
                table: "TravelReviews",
                column: "UserId");
        }
